...
enum RBACPermissions
{
    ...
    //Free 232-238
    RBAC_PERM_COMMAND_ARENA_CREATE = 232,
    RBAC_PERM_COMMAND_ARENA_DISBAND = 233,
    RBAC_PERM_COMMAND_ARENA_CAPTAIN = 235,
    RBAC_PERM_COMMAND_ARENA_INVITE = 236,
    RBAC_PERM_COMMAND_ARENA_INFO = 236,
    RBAC_PERM_COMMAND_ARENA_LOOKUP = 237,
    RBAC_PERM_COMMAND_ARENA = 238,
